  ...
  return (
    <div className='bg-white p-3 rounded-md'>
      <div className='w-full flex relative'>
        <div
          className={`w-[230px] md-lg:absolute transition-all bg-white md-lg:h-full ${
            ...
            <div className='w-full h-full'>
              <div className='flex justify-between items-center text-slate-600 text-xl h-[50px]'>
                ...
                <div
                  ...
                  className='w-[35px] hidden md-lg:flex rounded-sm cursor-pointer justify-center items-center bg-sky-600 text-white'
                >
                  <FaList />
                </div>
              </div>
