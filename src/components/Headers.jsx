...
import { language, logo } from '../assets/images';
          ...
          <div className='flex w-full justify-between items-center h-[50px] text-slate-500'>
            <ul className='flex justify-start items-center gap-8'>
              <li className='flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]'>
                ...
                <span>Smartshopasupport@gmail.com</span>
              </li>
              <span>Smartshopa</span>
            </ul>
            <div>
              <div className='flex justify-center items-center gap-10'>
                <div className='flex justify-center items-center gap-4'>
                  <a
                    href='https://www.facebook.com/profile.php?id=61553712732877&mibextid=ZbWKwL'
                    target='_blank'
                    rel='noreferrer'
                  >
                    <FaFacebookF />
                  ...
                  <a
                    href='https://x.com/Smartshopa_ex?t=gCbcccHfH0OoRAg35qn3Cw&s=09'
                    target='_blank'
                    rel='noreferrer'
                  >
                    <AiOutlineTwitter />
                  ...
                  <a
                    href='https://instagram.com/Smartshopa_ex?igshid=NzZlODBkYWE4Ng=='
                    target='_blank'
                    rel='noreferrer'
                  >
                    <AiFillInstagram />
        ...
        >
          <div className='flex justify-start flex-col gap-6'>
            ...
            <ul className='flex flex-col justify-start items-start gap-3 text-[#1c1c1c]'>
              ...
              <span className='text-sm'>Smartshopa</span>
            </ul>
          </div>
        </div>
      </div>
