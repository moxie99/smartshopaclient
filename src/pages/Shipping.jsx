...
const Shipping = () => {
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("https://smartshopaclient.vercel.app/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
