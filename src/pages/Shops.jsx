...
const Shops = () => {
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("https://smartshopaclient.vercel.app/shop.gif")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
        <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
          <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
            <div className='flex flex-col justify-center gap-1 items-center h-full w-full text-white'>
              <h2 className='text-3xl font-bold'>Smartshopa.ex</h2>
              ...
              <div className='py-2 flex flex-col gap-5'>
                ...
                <div>
                  <span className='text-red-500 font-bold text-lg'>
                    NGN{Math.floor(state.values[0])} - NGN
