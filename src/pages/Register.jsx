        ...
        <div className='w-full justify-center items-center p-10'>
          <div className='grid grid-cols-2 md:grid-cols-1 w-[60%] mx-auto bg-white rounded-md'>
                ...
                <form onSubmit={register} className='text-slate-600'>
                  <div className='flex flex-col gap-1 mb-2'>
                    ...
                    <input
                      ...
                      value={state.name}
                      type='text'
                      className='w-full px-3 py-2 border border-slate-200 outline-none focus:primary rounded-md'
                      id='name'
                      name='name'
                      placeholder='name'
                      required
                  ...
                  <div className='flex flex-col gap-1 mb-4 relative'>
                    ...
                    <input
                      ...
                      className='w-full px-3 py-2 border border-slate-200 outline-none focus:primary rounded-md pr-10' // Add pr-10 for icon space
                      id='password'
                      name='password'
                      placeholder='password'
                    />
                    <span
                      className='absolute top-1/2 right-3 transform  cursor-pointer'
            ...
            <div className='w-full h-full py-4 pr-4'>
              <img className='w-full h-[95%]' src={logo} alt='' />
            </div>
          </div>
        </div>
      </div>
