...
const Card = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("http://localhost:3000/card.jpg")] h-[300px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                            ...
                            <div className='w-[67%] md-lg:w-full'>
                                <div className='pr-3 md-lg:pr-0'>
                                    <div className='flex flex-col gap-3'>
                                        ...
                                        {
                                            card_products.map((p, i) => <div className='flex bg-white p-4 flex-col gap-2' key={i}>
                                                <div className='flex justify-start items-center'>
                                                    <h2 className='text-md text-slate-600'>{p.shopName}</h2>
                                                </div>
                                                {
                                                    p.products.map((pt, i) => <div className='w-full flex flex-wrap' key={i}>
                                                ...
                                                <div className='bg-white p-4'>
                                                    {
                                                        outofstock_products.map((p, i) => <div key={i} className='w-full flex flex-wrap'>
                                                            ...
                                                            <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                                                <div className='pl-4 sm:pl-0'>
                                                                    <h2 className='text-lg text-orange-500'>NGN{p.products[0].price - Math.floor((p.products[0].price * p.products[0].discount) / 100)} </h2>
                                ...
                                <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                                    {
                                        card_products.length > 0 && <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                            ...
                                            <div className='flex justify-between items-center'>
                                                <span>Total</span>
                                                <span className='text-lg text-orange-500'>NGN{price + shipping_fee}</span>
                                            </div>
